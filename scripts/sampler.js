...
audio1 = new Audio;  
audio1.src="di/"+coordenadas[0]+".wav";
audio1.volume = betweenf(0.13,0.33);

audio2 = new Audio;
audio2.src ="di/"+coordenadas[1]+".wav"    
audio2.volume = betweenf(0.13,0.33);
  
audio3 = new Audio;
audio3.src ="di/"+coordenadas[2]+".wav";    
audio3.volume = betweenf(0.13,0.33);
  
audio4 = new Audio;
audio4.src = "di/"+coordenadas[3]+".wav"   
audio4.volume = betweenf(0.13,0.33);
  
audio5 = new Audio;
audio5.src = "di/"+coordenadas[4]+".wav" 
audio5.volume = betweenf(0.13,0.33);
  
audio6 = new Audio;
audio6.src = "di/"+coordenadas[5]+".wav"   
